...
variable "vro_integration_name" {
  type        = string
  description = "Name of the vRealize Orchestrator Integration. (e.g. sfo-w01-vro-integration)"
}
variable "vro_integration_tag" {
  type        = string
  description = "Name of the Capability Tag for the vRealize Orchestrator Integration. (e.g. sfo-w01-vro)"
}
